...
class Net:
    """"
    Borrowed to https://github.com/zizhaozhang/unet-tensorflow-keras/blob/master/model.py
    """
    def __init__(self):
        self.model = None
    ...
    def define_net(self, input_shape, num_class):
        ...
        return self.model.input, self.model.output
